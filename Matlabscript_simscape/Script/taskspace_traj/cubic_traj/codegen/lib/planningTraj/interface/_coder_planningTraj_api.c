 ...
 * File: _coder_planningTraj_api.c
 *
...
/* Include Files */
#include "_coder_planningTraj_api.h"
#include "_coder_planningTraj_mex.h"
...
static real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *q0,
                      ...
                      const mxArray *plhs[2])
{
  ...
  v0 = emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "v0");
  v1 = emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "v1");
  tf = emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "tf");
  /* Invoke the target function */
  planningTraj(q0, q1, v0, v1, tf, q, v);
...
void planningTraj_atexit(void)
{
  ...
  planningTraj_xil_terminate();
  planningTraj_xil_shutdown();
...
/*
 * File trailer for _coder_planningTraj_api.c
 *
 * [EOF]
 */
