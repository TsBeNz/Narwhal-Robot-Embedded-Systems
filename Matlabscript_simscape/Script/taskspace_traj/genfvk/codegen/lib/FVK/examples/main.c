...
static void main_FVK(void)
{
  double q_tmp[5];
  double twist[3];
  /* Initialize function 'FVK' input arguments. */
  /* Initialize function input argument 'q'. */
  argInit_5x1_real_T(q_tmp);
  /* Initialize function input argument 'qd'. */
  /* Call the entry-point 'FVK'. */
  FVK(q_tmp, q_tmp, argInit_real_T(), twist);
}
