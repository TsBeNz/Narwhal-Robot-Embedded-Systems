function  [q2,q3,flag]= RRIK2(P004,gammabar,h1,h2,l1,l2,flag) %(P004,gammabar,h1,h2,l1,l2,flag)
    P023 = P004-[l1 ;0 ;h1];
    x24 = P023(1);
    z24 = P023(3);
