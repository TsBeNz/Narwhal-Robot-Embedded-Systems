...
#include "IKnarwhale5_terminate.h"
...
static void main_IKnarwhale5(void);
...
static void main_IKnarwhale5(void)
{
  ...
  double dv[4];
  double dv1[3];
  /* Initialize function 'IKnarwhale5' input arguments. */
  /* Initialize function input argument 'chi'. */
  /* Initialize function input argument 'gammabar'. */
