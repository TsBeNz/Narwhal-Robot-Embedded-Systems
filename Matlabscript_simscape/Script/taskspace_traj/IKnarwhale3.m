function [qbar,tod] = IKnarwhale3(P,rbar,gammabar,h1,h2,l1,l2,l3)
    R0e = eul2rotm(rbar(1:3),'ZYZ');

    q1 = atan2(R0e(2,3)/gammabar(1) , R0e(1,3)/gammabar(1))
    q5 = atan2(-R0e(3,2)/gammabar(2) , R0e(3,1)/gammabar(2))
    if (sqrt(P(1)^2+P(3)^2)<= (l2+h2)) && (sqrt(P(1)^2+P(3)^2)>=(l2-h2))
        c1 = cos(q1)
        s1 = sin(q1)
        tod = ((P(1)-P(2)) / c1-s1)- l1
