...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
//	float v_x[2] = {400.01,500};
//	float v_y[2]= {0,0};
//	float v_z[2] = {420.99,260};
//	float v_pitch[2] = {-3.1416,-3.1416};
//	float v_yaw[2] = {3.1416,3.1416};
	float q[5]={0,-0.6975,0.5554,0.1421,0};
	float qv[5];
	float v_x, v_y, v_z, v_pitch, v_yaw;
